...
[ParentID] [bigint] NOT NULL CONSTRAINT [DF__tmp_ms_xx__Paren__2B0A656D] DEFAULT ((0)),
...
[FileSize] [decimal] (18, 2) NOT NULL CONSTRAINT [DF__tmp_ms_xx__FileS__2BFE89A6] DEFAULT ((0)),
[ImgWidth] [int] NOT NULL CONSTRAINT [DF__tmp_ms_xx__ImgWi__2CF2ADDF] DEFAULT ((0)),
[ImgHeight] [int] NOT NULL CONSTRAINT [DF__tmp_ms_xx__ImgHe__2DE6D218] DEFAULT ((0)),
