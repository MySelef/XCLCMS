...
CONSTRAINT [PK_MERCHANT] PRIMARY KEY CLUSTERED  ([MerchantID]) ON [PRIMARY]
...
EXEC sp_addextendedproperty N'MS_Description', '商户类型(参见字典库)', 'SCHEMA', N'dbo', 'TABLE', N'Merchant', 'COLUMN', N'FK_MerchantType'
GO
