...
[FK_MerchantID] [bigint] NOT NULL CONSTRAINT [DF__tmp_ms_xx__FK_Me__38EE7070] DEFAULT ((0)),
...
CONSTRAINT [PK_SYSROLE] PRIMARY KEY CLUSTERED  ([SysRoleID]) ON [PRIMARY]
CREATE NONCLUSTERED INDEX [IX_RoleName] ON [dbo].[SysRole] ([RoleName]) ON [PRIMARY]

CREATE NONCLUSTERED INDEX [IX_FK_MerchantID] ON [dbo].[SysRole] ([FK_MerchantID]) ON [PRIMARY]
...
EXEC sp_addextendedproperty N'MS_Description', '所属商户号', 'SCHEMA', N'dbo', 'TABLE', N'SysRole', 'COLUMN', N'FK_MerchantID'
GO
