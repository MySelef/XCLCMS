...
namespace XCLCMS.WebAPI.Controllers
{
    ...
    public class ArticleController : BaseAPIController
    {
        ...
        public APIResponseEntity<bool> Add([FromBody] APIRequestEntity<XCLCMS.Data.WebAPIEntity.RequestEntity.Article.AddOrUpdateEntity> request)
        {
            var response = new APIResponseEntity<bool>();
        ...
        public APIResponseEntity<bool> Update([FromBody] APIRequestEntity<XCLCMS.Data.WebAPIEntity.RequestEntity.Article.AddOrUpdateEntity> request)
        {
            var response = new APIResponseEntity<bool>();
